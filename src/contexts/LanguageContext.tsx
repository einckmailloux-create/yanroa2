...
const zhTranslations = {
  ...
  registerPage: {
    ...
    errorPasswordLength: '密码长度至少为6个字符',
    errorDefault: '注册失败，请稍后再试',
    successMessage: '注册成功！请登录您的账户。',
    avatarUploadError: '头像上传失败',
    avatarUpdateError: '更新头像失败',
  },
};
...
const enTranslations = {
  ...
  registerPage: {
    ...
    generateAvatar: 'Generate Default Avatar',
    email: 'Email Address',
    password: 'Password',
