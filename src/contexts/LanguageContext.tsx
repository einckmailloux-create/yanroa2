...
const zhTranslations = {
  ...
  nav: {
    ...
    logout: '退出登录',
    bookNow: '立即预约',
    facialContour: '全面了解你的面部特征',
    bodySculpting: '经典个性化的面部设计',
    facialRejuvenation: '专业的面部改善指导',
    hairTransplant: '植发',
    dental: '牙齿美容',
  },
  hero: {
...
const enTranslations = {
  ...
  nav: {
    ...
    logout: 'Logout',
    bookNow: 'Book Now',
    facialContour: 'Comprehensive Facial Features Analysis',
    bodySculpting: 'Classic Personalized Facial Design',
    facialRejuvenation: 'Professional Facial Improvement Guidance',
